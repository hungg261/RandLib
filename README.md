...
- Random number generation (integers, floating-point, and big integers)
- Random strings with customizable character sets
- Random vectors and arrays
- Random graphs, trees, and DAGs
